...
import { Layout, Mail, Lock, Loader2, AlertCircle, Rocket, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 font-sans">
      <div className="max-w-xl w-full">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-black text-slate-900 mb-3 tracking-tighter">FivoPay Workspace</h1>
          <p className="text-slate-400 font-bold text-lg">Enter your credentials to continue your journey.</p>
        </div>
        ...
        <div className="bg-white rounded-[48px] shadow-premium p-12 border border-slate-50 relative overflow-hidden group">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between ml-2">
                <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-slate-300">Password</label>
                <Link to="/reset-password" className="text-[10px] font-black uppercase tracking-wider text-accent-indigo hover:underline mr-2">Forgot Password?</Link>
              </div>
              <div className="relative group">
          ...
          <div className="mt-12 text-center border-t border-slate-50 pt-8 relative z-10">
            <p className="text-slate-400 text-sm font-bold">
              ...
              <Link to="/signup" className="text-accent-indigo font-black hover:underline ml-1">
                Create Account
              </Link>
            </p>
          </div>
